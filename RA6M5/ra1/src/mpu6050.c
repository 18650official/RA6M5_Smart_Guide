...
void MPU6050_ConvertToResult(MPU_Result_Typedef* res)
{
	...
	res->acc[0] = ax / 16384.0f;
	res->acc[1] = ay / 16384.0f;
	res->acc[2] = az / 16384.0f;
	res->gyro[0] = gx / 131.0f;
	res->gyro[1] = gy / 131.0f;
	res->gyro[2] = gz / 131.0f;
	res->temp = temp / 340.0f + 16.53f;
}
