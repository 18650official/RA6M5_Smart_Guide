...
const icu_extended_cfg_t g_external_irq8_ext_cfg = { .filter_src =
		EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq8_cfg = { .channel = 8, .trigger =
		EXTERNAL_IRQ_TRIG_BOTH_EDGE, .filter_enable = true, .clock_source_div =
		EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64, .p_callback = exti8_callback,
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = (void*) &g_external_irq8_ext_cfg, .ipl = (12),
...
const external_irq_instance_t g_external_irq8 = { .p_ctrl =
		&g_external_irq8_ctrl, .p_cfg = &g_external_irq8_cfg, .p_api =
		&g_external_irq_on_icu };
icu_instance_ctrl_t g_external_irq7_ctrl;

/** External IRQ extended configuration for ICU HAL driver */
const icu_extended_cfg_t g_external_irq7_ext_cfg = { .filter_src =
		EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq7_cfg = { .channel = 7, .trigger =
		EXTERNAL_IRQ_TRIG_BOTH_EDGE, .filter_enable = true, .clock_source_div =
		EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64, .p_callback = exti7_callback,
/** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
		.p_context = (void*) &NULL,
#endif
		.p_extend = (void*) &g_external_irq7_ext_cfg, .ipl = (12),
